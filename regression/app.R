...
ui <- fluidPage(title = "Regression with Day of Week",
                ...
                sidebarLayout(
                  sidebarPanel(tags$h4("Select Base Data Parameters"),
                               ...
                               tags$br(),
                               tags$hr(),
                               tags$h4("Choose a Reference Variable!"),
                               tags$div("It doesn't (really) matter what you choose for the reference variable (the", 
                                        "value for the dummy variable that will be dropped when the dummies are created.",
                                        "The model will be (almost) the same (although the coefficients will change!),",
