...
A series of analyses of pages for a site running Google Analytics.
...
## Overall visualization of x vs. y
...
scale_x <- if(x_scale == "linear"){
  scale_x_continuous(labels = format_x)
} else {
  scale_x_log10(labels = format_x)
}

scale_y <- if(y_scale == "linear"){
  scale_y_continuous(labels = format_x)
} else {
  scale_y_log10(labels = format_x)
}
